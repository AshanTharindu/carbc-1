...
//        sendAgreements();
    ...
    public static JSONObject createRegisterJSON(){
        ...
        registration.put("registrationNumber", "B");
        ...
        registration.put("engineNumber", "B");
        registration.put("vehicleClass", "B");
        registration.put("conditionAndNote", "B");
        registration.put("make", "B");
        registration.put("model", "B");
        registration.put("yearOfManufacture", "B");
